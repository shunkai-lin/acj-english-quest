...
const TOPICS = [
  ...
  // kind=pic ：圖是寶可夢官方美術圖（吃 POKEMON_LIST，questions.js 在 pokemon-data.js 之後載入）
  {
    ...
    items: [
      ...
      pk("Rattata",      19, 2), pk("Spearow",      21, 2), pk("Nidoran",      29, 2),
      pk("Nidoran",      32, 2), pk("Jigglypuff",   39, 2), pk("Venonat",      48, 2),
      pk("Diglett",      50, 2), pk("Dugtrio",      51, 2), pk("Meowth",       52, 2),
      pk("Persian",      53, 2), pk("Psyduck",      54, 2), pk("Golduck",      55, 2),
      pk("Poliwag",      60, 2), pk("Kadabra",      64, 2), pk("Machoke",      67, 2),
      pk("Machamp",      68, 2), pk("Slowbro",      80, 2), pk("Dewgong",      87, 2),
      pk("Haunter",      93, 2), pk("Gengar",       94, 2), pk("Drowzee",      96, 2),
      pk("Kingler",      99, 2), pk("Voltorb",     100, 2), pk("Marowak",     105, 2),
      pk("Koffing",     109, 2), pk("Weezing",     110, 2), pk("Rhyhorn",     111, 2),
      pk("Chansey",     113, 2), pk("Tangela",     114, 2), pk("Goldeen",     118, 2),
      pk("Seaking",     119, 2), pk("Starmie",     121, 2), pk("Scyther",     123, 2),
      pk("Jolteon",     135, 2), pk("Flareon",     136, 2), pk("Kabuto",      140, 2),
      pk("Snorlax",     143, 2), pk("Furret",      162, 2), pk("Ledyba",      165, 2),
      pk("Ledian",      166, 2), pk("Crobat",      169, 2), pk("Cleffa",      173, 2),
      pk("Togepi",      175, 2), pk("Mareep",      179, 2), pk("Marill",      183, 2),
      pk("Hoppip",      187, 2), pk("Wooper",      194, 2), pk("Espeon",      196, 2),
      pk("Pineco",      204, 2), pk("Gligar",      207, 2), pk("Scizor",      212, 2),
      pk("Slugma",      218, 2), pk("Swinub",      220, 2), pk("Phanpy",      231, 2),
      pk("Elekid",      239, 2), pk("Raikou",      243, 2),
      ...
      pk("Nidoqueen",    31, 4), pk("Ninetales",    38, 4), pk("Wigglytuff",   40, 4),
      pk("Vileplume",    45, 4), pk("Poliwhirl",    61, 4), pk("Poliwrath",    62, 4),
      pk("Bellsprout",   69, 4), pk("Weepinbell",   70, 4), pk("Victreebel",   71, 4),
      pk("Tentacool",    72, 4), pk("Tentacruel",   73, 4), pk("Magnemite",    81, 4),
      pk("Farfetch'd",   83, 4), pk("Electrode",   101, 4), pk("Exeggcute",   102, 4),
      pk("Exeggutor",   103, 4), pk("Hitmonlee",   106, 4), pk("Hitmonchan",  107, 4),
      pk("Lickitung",   108, 4), pk("Kangaskhan",  115, 4), pk("Electabuzz",  125, 4),
      pk("Aerodactyl",  142, 4), pk("Articuno",    144, 4), pk("Zapdos",      145, 4),
      pk("Moltres",     146, 4), pk("Dragonair",   148, 4), pk("Dragonite",   149, 4),
      pk("Mewtwo",      150, 4), pk("Chikorita",   152, 4), pk("Cyndaquil",   155, 4),
      pk("Typhlosion",  157, 4), pk("Feraligatr",  160, 4), pk("Igglybuff",   174, 4),
      pk("Bellossom",   182, 4), pk("Azumarill",   184, 4), pk("Sudowoodo",   185, 4),
      pk("Misdreavus",  200, 4), pk("Wobbuffet",   202, 4), pk("Girafarig",   203, 4),
      pk("Forretress",  205, 4), pk("Dunsparce",   206, 4), pk("Snubbull",    209, 4),
      pk("Granbull",    210, 4), pk("Qwilfish",    211, 4), pk("Heracross",   214, 4),
      pk("Teddiursa",   216, 4), pk("Ursaring",    217, 4), pk("Magcargo",    219, 4),
      pk("Piloswine",   221, 4), pk("Remoraid",    223, 4), pk("Octillery",   224, 4),
      pk("Delibird",    225, 4), pk("Skarmory",    227, 4), pk("Houndour",    228, 4),
      pk("Houndoom",    229, 4), pk("Stantler",    234, 4), pk("Smeargle",    235, 4),
      pk("Hitmontop",   237, 4), pk("Smoochum",    238, 4), pk("Larvitar",    246, 4),
      pk("Tyranitar",   248, 4), pk("Cresselia",   488, 4)
    ]
  }
];
