...
const TOPICS = [
  ...
  // ───────────── 第二批：三個第一批關卡都到 L3 才解鎖，起跳 L2（沒有中文提示） ─────────────
  {
    ...
    items: [
      ...
      { word: "banana milk",zh: "香蕉牛奶",img: "🍌", level: 3, nearMiss: ["banana", "milk"] },
  ...
  },
  {
    ...
    items: [
      ...
      { word: "knee",     zh: "膝蓋",   img: "🦵", level: 3, nearMiss: ["need", "new"] },
      ...
      { word: "elbow",    zh: "手肘",   img: "💪", level: 4, nearMiss: ["below", "yellow"] },
      ...
      { word: "brain",    zh: "腦",     img: "🧠", level: 4, nearMiss: ["train", "rain"] }
    ]
  },
  {
    ...
    items: [
      ...
      { word: "family",   zh: "家人",     img: "👨‍👩‍👧", level: 2, nearMiss: ["funny", "fish"] },
      { word: "friend",   zh: "朋友",     img: "🧒", level: 2, nearMiss: ["find", "frog"] },
      { word: "boy",      zh: "男孩",     img: "👦", level: 2, nearMiss: ["toy", "boat"] },
      { word: "girl",     zh: "女孩",     img: "👧", level: 2, nearMiss: ["giraffe", "gold"] },
      { word: "teacher",  zh: "老師",     img: "🧑‍🏫", level: 3, nearMiss: ["tiger", "ten"] },
      { word: "man",      zh: "男人",     img: "🧑", level: 3, nearMiss: ["mom", "many"] },
      { word: "woman",    zh: "女人",     img: "👩", level: 3, nearMiss: ["man", "women"] },
      { word: "son",      zh: "兒子",     img: "🧒", level: 3, nearMiss: ["sun", "song"] },
      { word: "daughter", zh: "女兒",     img: "👧", level: 3, nearMiss: ["doctor", "water"] },
      { word: "uncle",    zh: "叔叔",     img: "🧔", level: 3, nearMiss: ["ankle", "apple"] },
      { word: "aunt",     zh: "阿姨",     img: "👩‍🦰", level: 3, nearMiss: ["ant", "arm"] },
      { word: "cousin",   zh: "堂表兄妹", img: "🧑‍🤝‍🧑", level: 3, nearMiss: ["cook", "coming"] },
      { word: "doctor",   zh: "醫生",     img: "🧑‍⚕️", level: 3, nearMiss: ["daughter", "dog"] },
      { word: "nurse",    zh: "護士",     img: "👩‍⚕️", level: 3, nearMiss: ["horse", "purse"] },
      { word: "police",   zh: "警察",     img: "👮", level: 3, nearMiss: ["please", "place"] },
      { word: "farmer",   zh: "農夫",     img: "🧑‍🌾", level: 4, nearMiss: ["father", "far"] },
      { word: "cook",     zh: "廚師",     img: "🧑‍🍳", level: 4, nearMiss: ["book", "cookie"] },
      { word: "driver",   zh: "司機",     img: "🧑‍✈️", level: 4, nearMiss: ["river", "drive"] },
      { word: "singer",   zh: "歌手",     img: "🧑‍🎤", level: 4, nearMiss: ["finger", "sister"] },
      { word: "firefighter", zh: "消防員", img: "🧑‍🚒", level: 4, nearMiss: ["fire", "fighter"] },
      { word: "student",  zh: "學生",     img: "🧑‍🎓", level: 4, nearMiss: ["stand", "study"] },
      { word: "neighbor", zh: "鄰居",     img: "🏘️", level: 4, nearMiss: ["never", "number"] },
      { word: "twins",    zh: "雙胞胎",   img: "👯", level: 4, nearMiss: ["twelve", "wins"] }
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { word: "corner",    zh: "角落",   img: "📐", level: 4, nearMiss: ["corn", "color"] },
  ...
  },
  {
    ...
    items: [
      ...
      { word: "class",      zh: "班級",   img: "🏫", level: 3, nearMiss: ["glass", "grass"] },
      ...
      { word: "backpack",   zh: "背包",   img: "🎒", level: 4, nearMiss: ["back", "pack"] },
      { word: "marker",     zh: "麥克筆", img: "🖊️", level: 4, nearMiss: ["market", "maker"] },
  ...
  },
  {
    ...
    items: [
      ...
      { word: "rain",      zh: "雨",     img: "🌧️", level: 3, nearMiss: ["train", "rainy"] },
